...
export const PipelineSquare = ({ pipelineData }: PipelineSquareProps) => {
	return (
		<Card sx={{ width: "300px", height: "300px", padding: "10px", borderRadius: "15px" }}>
			<div
				style={{
					width: "100%",
					height: "100%",
				...
				<div style={{ gridArea: "PipelineTitle", width: "100%", alignSelf: "start", justifySelf: "start" }}>
					<Typography sx={{ wordWrap: "break-word" }} align="left" variant="h3">
						{pipelineData.name.length < 20 ? pipelineData.name : pipelineData.name.substring(0, 20) + "..."}
					</Typography>
				</div>
